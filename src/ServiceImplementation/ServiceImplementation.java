...
//SESSIONS
    ...
    public boolean createSession (Session session) {
        ...
        try {
            createSessionSQL.setString(1, session.getSessionId()); //createSessionSQL.setString(1, md5Hash(session.getSessionId()));
    ...
    public Session getSession (String sessionId) {
        ...
        try {
            getSessionSQL.setString(1, sessionId); //getSessionSQL.setString(1, md5Hash(sessionId));
